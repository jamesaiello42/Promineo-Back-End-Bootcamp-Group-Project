...
import java.util.List;
	...
	public class PostsDao {
		...
		// Create a new post
		private final String CREATE_POSTS_QUERY = "INSERT INTO POSTS (POSTER_ID, POST_TEXT, DATE_POSTED, DATE_EDITED) VALUES (?, ?, NOW(), NOW())";
		//Update a post
		...
		public void createNewPost(int posterId, String postText) throws SQLException {	
